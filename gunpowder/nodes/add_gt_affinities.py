...
class AddGtAffinities(BatchFilter):
    ...
    def setup(self):
        ...
        assert VolumeType.GT_LABELS in self.spec.volumes, "AddGtAffinities can only be used if you GT_LABELS provided"
        self.spec.volumes[VolumeType.GT_AFFINITIES] = self.spec.volumes[VolumeType.GT_LABELS]
