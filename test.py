...
crop_gt_padded = gunpowder.CropGt(1)
...
crop_gt = gunpowder.CropGt()
snapshot_final = gunpowder.Snapshot(every=1)
# SegEM sized batch
# precache = gunpowder.PreCache(
