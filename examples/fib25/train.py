...
def train_until(max_iteration, gpu):
    ...
    train_pipeline = (
        ...
        Train(
            ...
            inputs={
                ArrayTypes.RAW: 'data',
                ArrayTypes.GT_AFFINITIES: 'aff_label',
            },
            outputs={
                ArrayTypes.PRED_AFFINITIES: 'aff_pred'
            },
            gradients={
                ArrayTypes.LOSS_GRADIENT: 'aff_pred'
            },
            resolutions={
                ArrayTypes.PRED_AFFINITIES: Coordinate((8,8,8)),
                ArrayTypes.LOSS_GRADIENT: Coordinate((8,8,8)),
            },
            use_gpu=gpu) +
